  ...
  return (
    <div className="flex flex-col p-10 items-center mt-20">
        ...
        <div className="flex flex-row gap-5">
            <div className="rounded-2xl w-1/2 border-[1px] p-2 border-gray-500">
            <div className="w-full rounded-[8px] bg-cover bg-center" style={{backgroundImage: `url('/assets/heroimage3.jpg')`}}>asd</div>
            </div>
        </div>
    </div>
  )
