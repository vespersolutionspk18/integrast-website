  ...
  return (
    <div className="w-full flex flex-col p-10 items-center mt-20">
        ...
        <div className="flex flex-row mt-10 gap-5 w-full">
            <div className="flex flex-col rounded-2xl w-1/2 h-[540px] border-[1px] p-4 border-gray-300">
            ...
            <p className="font-sans font-light text-gray-600 text-xl mt-3">Explore essential tax-saving strategies and financial tips to optimize your returns with insights from our expert personal accountants.</p>
            </div>
        </div>
    </div>
  )
