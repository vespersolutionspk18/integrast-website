  ...
  return (
    <div className="flex flex-col p-10 mt-16 ">
        ...
        <div className="flex flex-row gap-5 mt-16">
            <div className="rounded-2xl w-1/3 h-[540px] bg-cover bg-center flex items-end" style={{backgroundImage: `url('/assets/heroimage4.jpg')`}}>
            <div className="bg-white m-4 w-full  rounded-[12px] flex flex-col">
            <h5 className="ml-5 mt-5 mr-5 mb-2 font-sans text-3xl text-gray-700 font-light">Audit & Assurance</h5>    
            <p className="ml-5 mr-5 mb-5 text-justify font-sans font-light text-xl text-gray-700">We are committed to serving the public interest by providing objective assurance over data on which investors rely.</p>
            </div></div>
