    ...
    <div className="flex flex-col p-10 ">
        <div className="flex flex-row mt-24 h-[190px] gap-5 ">
            ...
            <div className="w-[45%] flex flex-col justify-between ">
                ...
                <div>
                <div id="button"
  className="group  bg-white h-[44px] flex-row border-[1px] border-gray-800 text-gray-900 text-[16px] py-1 px-1 font-light rounded-full hidden md:flex items-center justify-between w-[200px] transition-width duration-500 ease-in-out  hover:w-[225px] "
  
>
  <div className="mx-3 font-sans font-regular">Get a Price Quote</div>
  <div className="bg-white border-[0.5px] border-gray-800 rounded-full h-[36px] w-[36px] flex items-center justify-center transition-transform duration-500 ease-in-out group-hover:rotate-45">
