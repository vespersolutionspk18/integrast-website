  ...
  return (
    <div className="flex flex-col p-10 mt-16 ">
        ...
        <div className="flex flex-row gap-5 mt-16">
            <div className="rounded-2xl w-1/3 h-[640px] bg-cover bg-center flex items-end" style={{backgroundImage: `url('/assets/heroimage4.jpg')`}}><div className="bg-white m-5 w-full h-[240px] rounded-[11px]"></div></div>
