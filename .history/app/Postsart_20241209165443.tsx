  ...
  return (
    <div className="flex flex-col p-10 items-center mt-20">
        ...
        <div className="flex flex-row gap-5">
            <div className="flex flex-col rounded-2xl w-1/2 h-[340px] border-[1px] p-2 border-gray-500">
            <div className="w-full h-full rounded-[8px] bg-cover bg-center" style={{backgroundImage: `url('/assets/heroimage3.jpg')`}}>asdasdadsasd</div>
            </div>
        </div>
    </div>
  )
