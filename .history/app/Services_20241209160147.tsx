  ...
  return (
    <div className="flex flex-col p-10 mt-16 ">
        ...
        <div className="flex flex-row gap-5 mt-16">
            <div className="rounded-2xl w-1/3 h-[640px] bg-cover bg-center flex items-end" style={{backgroundImage: `url('/assets/heroimage4.jpg')`}}><div className="bg-white m-4 w-full h-[240px] rounded-[12px] flex flex-col">
            <h5 className="m-5 font-sans text-3xl text-gray-700 font-light">Audit & Assurance</h5>    
            <p className="ml-5 mb-5 font-sans font-light text-xl text-gray-700">We are committed to serving th public interest by providing objective assurance over data on which investors rely.</p>
            </div></div>
