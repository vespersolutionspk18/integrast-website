    ...
    <div className="flex flex-col p-10 ">
        <div className="flex flex-row mt-24 h-[280px] gap-5 ">
            ...
            <div className="w-[45%] flex flex-col items-start ">
                ...
                <div id="button"
  className="group  bg-white h-[44px] flex-row border-[1px] text-gray-900 text-[16px] py-1 px-1 font-light rounded-full hidden md:flex items-center justify-between w-[200px] transition-width duration-500 ease-in-out  hover:w-[225px] "
