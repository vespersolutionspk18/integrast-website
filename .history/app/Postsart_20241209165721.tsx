  ...
  return (
    <div className="w-full flex flex-col p-10 items-center mt-20">
        ...
        <div className="flex flex-row mt-10 gap-5 w-full">
            <div className="flex flex-col rounded-2xl w-1/2 h-[340px] border-[1px] p-4 border-gray-200">
            <div className="w-full h-[240px] rounded-[8px] bg-cover bg-center" style={{backgroundImage: `url('/assets/heroimage3.jpg')`}}></div>
            </div>
        </div>
    </div>
  )
