...
const Services = () => {
  ...
  {/* Hidden button */}
  <button className="absolute bottom-5 left-5 bg-blue-500 text-white px-4 py-2 rounded-md opacity-0 invisible transition-opacity duration-500 hover:bg-blue-600 group-hover:opacity-100 group-hover:visible">
    Learn More
  </button>
</div>
