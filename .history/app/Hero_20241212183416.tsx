  ...
  <div className="bg-gray-700 rounded-full h-[36px] w-[36px] flex items-center justify-center transition-transform duration-500 ease-in-out group-hover:rotate-45 group-hover:bg-[#ec8123]">
    <ButtonArrowwhite className="h-[24px] w-[24px]" />
        ...
        <div className="flex flex-col md:flex-row md:h-[380px] gap-4 mt-6 md:mt-16">
            <div className="w-full md:w-[70%] h-20 transition-all duration-500 ease-in-out hover:w-[90%] rounded-2xl bg-cover bg-center" style={{backgroundImage: `url('/assets/heroimage3.jpg')`}}></div>
