...
const Header = () => {
  return (
    <div className="md:pl-10 pl-5 pr-5 md:pr-10 pt-3 md:pt-1 md:pb-3 flex flex-row justify-between font-sans font-light text-gray-800">
      <IntegraLogo className="md:h-[90px] md:w-[200px] h-[50px]" />
