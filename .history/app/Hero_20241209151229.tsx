    ...
    <ButtonArrow className="h-[24px] w-[24px]" />
        ...
        <div className="flex flex-row h-[380px] gap-4 mt-16">
            ...
            <div className="w-[35%] flex flex-col justify-between ">
                ...
                <h5 className="font-sans text-gray-800 text-justify text-xl mt-3 tracking-tighter">Tailored solutions, expert guidance, and strategic planning to secure your wealth and achieve your financial goals seamlessly</h5>
            </div>
        </div>
    </div>
  )
