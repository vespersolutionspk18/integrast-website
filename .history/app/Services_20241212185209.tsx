...
const Services = () => {
  return (
    <div className="flex flex-col p-10 mt-8 lg:mt-16 items-center ">
        <div className="flex flex-col md:flex-row items-start justify-start ">
            <div className="w-1/2 font-sans font-light text-5xl text-[#ec8123]">We collaborate across <span className="text-gray-700">diverse industry landscapes</span></div>
