    ...
    <div className="flex flex-col p-10 ">
        <div className="flex flex-row mt-24 h-[190px] gap-5 ">
            ...
            <div className="w-[45%] flex flex-col justify-between ">
                ...
                <div>
                <div id="button"
  className="group  bg-white h-[44px] flex-row border-[1px] border-gray-700 text-gray-900 text-[16px] py-1 px-1 font-light rounded-full hidden md:flex items-center justify-between w-[180px] transition-width duration-500 ease-in-out  hover:w-[205px] hover:bg-gray-700 hover:border-gray-700 hover:text-white "
