  ...
  <div className="bg-white rounded-full h-[36px] w-[36px] flex items-center justify-center transition-transform duration-500 ease-in-out group-hover:rotate-45">
    <ButtonArrow className="h-[24px] w-[24px]" />
        ...
        <div className="flex flex-row h-[380px] gap-4 mt-16">
            <div className="w-[70%] rounded-2xl bg-cover bg-center" style={{backgroundImage: `url('/assets/heroimage3.jpg')`}}></div>
            <div className="w-[30%] flex flex-col justify-between ">
                <div className="w-full h-[85%] rounded-2xl bg-cover bg-center" style={{backgroundImage: `url('/assets/heroimage4.jpg')`}}></div>
                <h5 className="font-sans text-gray-800 text-justify text-xl mt-3 tracking-tighter font-light">Tailored solutions, expert guidance, and strategic planning to secure your wealth and achieve your financial goals seamlessly</h5>
            </div>
        </div>
    </div>
  )
