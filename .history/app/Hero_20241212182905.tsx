...
const Hero = () => {
  return (
    <div className="flex flex-col p-10 ">
        <div className="flex flex-col md:flex-row mt-24 h-[190px] gap-5 ">
            <div className="w-[55%] flex flex-col">
                <h1 className="font-light font-sans text-3xl md:text-6xl text-[#ec8123]">Unlock Prosperity, <span className="text-gray-800">Choose Expert Guidance</span></h1>
...
>
  ...
  <div className="bg-gray-700 rounded-full h-[36px] w-[36px] flex items-center justify-center transition-transform duration-500 ease-in-out group-hover:rotate-45 group-hover:bg-[#ec8123]">
    <ButtonArrowwhite className="h-[24px] w-[24px]" />
        ...
        <div className="flex flex-row h-[380px] gap-4 mt-16">
            <div className="w-[70%] transition-all duration-500 ease-in-out hover:w-[90%] rounded-2xl bg-cover bg-center" style={{backgroundImage: `url('/assets/heroimage3.jpg')`}}></div>
            <div className="w-[30%] transition-all duration-500 ease-in-out hover:w-[40%] flex flex-col justify-between ">
                <div className="w-full h-full rounded-2xl bg-cover bg-center" style={{backgroundImage: `url('/assets/heroimage4.jpg')`}}></div>
                <h5 className="font-sans text-gray-900 text-justify text-xl mt-3  font-light">Tailored solutions, expert guidance, and strategic planning to secure your wealth and achieve your financial goals seamlessly</h5>
            </div>
        </div>
    </div>
  )
