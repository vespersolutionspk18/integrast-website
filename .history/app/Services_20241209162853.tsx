...
const Services = () => {
  ...
  <div className="bg-white m-4  rounded-[12px] flex flex-col relative transition-all duration-500 ease-in-out hover:pb-[120px] min-h-[180px]">
    ...
    {/* Hidden div */}
    <div className="absolute bottom-5 left-5 text-xl font-sans font-light  text-gray-700 px-4 py-2 rounded-md opacity-0 invisible transition-all duration-500 group-hover:opacity-100 group-hover:visible">
      Learn More
    </div>
  </div>
</div>
