    ...
    <ButtonArrowwhite className="h-[24px] w-[24px]" />
        ...
        <div className="flex flex-row md:h-[380px] gap-4 mt-6 md:mt-16">
            ...
            <div className="w-[30%] transition-all duration-500 ease-in-out hover:w-[40%] flex flex-col justify-between ">
                ...
                <h5 className="hidden md:block font-sans text-gray-900 text-justify text-xl mt-3  font-light">Tailored solutions, expert guidance, and strategic planning to secure your wealth and achieve your financial goals seamlessly</h5>
            </div>
        </div>
    </div>
  )
