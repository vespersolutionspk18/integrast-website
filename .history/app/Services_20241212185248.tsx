...
const Services = () => {
  return (
    <div className="flex flex-col p-10 mt-2 lg:mt-16 items-center ">
        <div className="flex flex-col md:flex-row items-start justify-start ">
            <div className="w-full lg:w-1/2 font-sans font-light text-5xl text-[#ec8123]">We collaborate across <span className="text-gray-700">diverse industry landscapes</span></div>
            <div className="w-full lg:w-1/2 font-sans text-gray-900 text-justify text-xl  font-light">Our commitment to fostering dynamic collaboration allows to navigate the unique challenges and intricacies of various sectors. Our versatile approach ensures tailored solutions that resonate with the distinct needs of each industry.</div>
        </div>
