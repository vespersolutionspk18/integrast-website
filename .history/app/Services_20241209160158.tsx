  ...
  return (
    <div className="flex flex-col p-10 mt-16 ">
        ...
        <div className="flex flex-row gap-5 mt-16">
            ...
            <p className="ml-5 font-sans font-light text-xl text-gray-700">We are committed to serving the public interest by providing objective assurance over data on which investors rely.</p>
            </div></div>
