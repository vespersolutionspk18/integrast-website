...
const Header = () => {
  return (
    <div className="md:pl-10 pl-5 pr-5 md:pr-10 pt-4 md:pt-1 md:pb-3 flex flex-row justify-between sm:items-center font-sans font-light text-gray-800">
      <IntegraLogo className="md:h-[90px] flex md:w-[200px] h-[30px]" />
...
>
  ...
  <div className="bg-white rounded-full h-[36px] w-[36px] flex items-center justify-center transition-transform duration-500 ease-in-out group-hover:rotate-45 ">
    <ButtonArrow className="h-[24px] w-[24px]" />
      ...
      <div className="md:hidden flex border-[1px] border-gray-400 rounded-xl p-3">
