  ...
  return (
    <div className="flex flex-col p-10 mt-16 items-center ">
        ...
        <div className="flex flex-row gap-5 mt-16">
            ...
            <div className="bg-white m-4 w-full rounded-[12px] flex flex-col transition-all duration-500 ease-in-out hover:pb-[120px] min-h-[200px]">
  <h5 className="ml-5 mt-5 mr-5 mb-5 font-sans text-3xl text-gray-700 font-light">
    Accounting & Finance
  </h5>
  <p className="ml-5 mr-5  text-justify font-sans font-light text-xl text-gray-600">
