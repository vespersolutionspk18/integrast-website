...
const Faqsection = () => {
  return (
    ...
    <div className="w-full flex flex-col gap-5 mt-5">
        <div className="border-[1px] border-gray-300 rounded-2xl items-center p-5">
            <h5 className="font-sans font-light text-3xl text-gray-700">What Services do personal accountants provide?</h5>
        </div>
    </div>
    </div>
  )
