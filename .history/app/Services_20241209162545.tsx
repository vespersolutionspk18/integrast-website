...
const Services = () => {
  ...
  {/* Hidden button */}
  <div className="absolute bottom-5 left-5 bg-blue-500 text-black px-4 py-2 rounded-md  invisible transition-opacity duration-500 hover:bg-blue-600 group-hover:opacity-100 group-hover:visible">
    Learn More
  </div>
</div>
