  ...
  return (
    ...
    <div className="w-full flex flex-col gap-5 mt-5">
        <div className="border-[1px] border-gray-300 rounded-2xl items-center p-5 flex flex-row justify-between">
            ...
            <div className="bg-white border-[1px] border-gray-500 rounded-full h-[36px] w-[36px] flex items-center justify-center transition-transform duration-500 ease-in-out group-hover:rotate-45">
