  ...
  return (
    <div className="flex flex-col p-10 ">
        <div className="flex flex-row mt-24 h-[280px] gap-5 ">
            ...
            <div className="w-[45%]">
                <h4 className="text-xl font-sans text-slate-800 mt-6">Unlock tailored strategies, benefit from insightful guidances, and follow a clear pathway to achieve your financial success. Elevate your financial journey with our dedicated support and expertise</h4>
            </div>
        </div>
    </div>
  )
